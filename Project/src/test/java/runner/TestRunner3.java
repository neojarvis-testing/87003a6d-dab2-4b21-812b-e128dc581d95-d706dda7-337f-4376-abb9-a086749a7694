...
public class TestRunner3 extends Base{
    ...
    public void testcase4(){
        try {
            ...
            businessActions.inputPhno(test);
            businessActions.inputCountry(test);
            businessActions.inputCompany(test);
            businessActions.inputAddressField(test);
            businessActions.inputSubjectField(test);
            businessActions.inputMsg(test);

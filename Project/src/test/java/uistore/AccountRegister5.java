...
public class AccountRegister5 {
    ...
    public static By passwordConfirm = By.cssSelector("input[placeholder='Password confirm']");

    public static By signup = By.id("sc_button-form-process");
